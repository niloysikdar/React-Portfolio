export const ProjectsData = [
  {
    ...
    image: 'https://i.imgur.com/wpznb1x.png',
    GitHub: 'https://github.com/niloysikdar/RememBirth',
    hosted: 'https://remembirth.vercel.app/',
  },
  {
    title: 'Plaso Connect',
  ...
  {
    title: 'CodeChef Peek',
    description: `Mobile application to view the statistics of CodeChef Users with just one click.
    Downloaded by 200+ users.`,
    image: 'https://i.imgur.com/IkaBaNN.png',
    GitHub: 'https://github.com/niloysikdar/CodeChef-Peek',
    hosted: `https://play.google.com/store/apps/details?id=com.codechef.peek.android`,
  },
  {
    title: 'Pdf Chest',
    description: `An application to search and get the list of available pdfs related to a topic. Download them for free.`,
    image: 'https://i.imgur.com/gNfLR0a.png',
    GitHub: 'https://github.com/niloysikdar/PdfChest',
    hosted: `https://play.google.com/store/apps/details?id=com.pdfchest.android`,
  },
  {
    title: 'WeShare',
  ...
  {
    title: 'Grow Green',
    description: `A mobile app to bring more customers to the small businesses that have negatively been impacted by COVID-19`,
